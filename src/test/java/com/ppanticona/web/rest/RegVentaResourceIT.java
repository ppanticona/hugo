...
@WithMockUser
public class RegVentaResourceIT {
    ...
    private static final Float DEFAULT_IGV_IPM = 1F;
    private static final Float UPDATED_IGV_IPM = 2F;

    private static final Float DEFAULT_DSCTO_IGV_IPM = 1F;
    private static final Float UPDATED_DSCTO_IGV_IPM = 2F;

    private static final Float DEFAULT_IMP_OPE_EXO = 1F;
    private static final Float UPDATED_IMP_OPE_EXO = 2F;

    private static final Float DEFAULT_IMP_TOT_OPE_INAFEC = 1F;
    private static final Float UPDATED_IMP_TOT_OPE_INAFEC = 2F;

    private static final Float DEFAULT_IMP_SEC_CONS = 1F;
    private static final Float UPDATED_IMP_SEC_CONS = 2F;

    private static final Float DEFAULT_BASE_IMP_ARROZ = 1F;
    private static final Float UPDATED_BASE_IMP_ARROZ = 2F;

    private static final Float DEFAULT_IMP_VENT_ARROZ = 1F;
    private static final Float UPDATED_IMP_VENT_ARROZ = 2F;

    private static final Float DEFAULT_OTROS_NO_BASE_IMP = 1F;
    private static final Float UPDATED_OTROS_NO_BASE_IMP = 2F;
    ...
    private static final Float DEFAULT_TIP_CAMBIO = 1F;
    private static final Float UPDATED_TIP_CAMBIO = 2F;
    ...
    @Test
    public void createRegVenta() throws Exception {
        int databaseSizeBeforeCreate = regVentaRepository.findAll().size();
        // Create the RegVenta
        restRegVentaMockMvc.perform(post("/api/reg-ventas")
        ...
        assertThat(testRegVenta.getMes()).isEqualTo(DEFAULT_MES);
        ...
        assertThat(testRegVenta.isIndDel()).isEqualTo(DEFAULT_IND_DEL);
    ...
    @Test
    public void createRegVentaWithExistingId() throws Exception {
        int databaseSizeBeforeCreate = regVentaRepository.findAll().size();
    ...
    @Test
    public void checkFecEmiCompIsRequired() throws Exception {
        int databaseSizeBeforeTest = regVentaRepository.findAll().size();
        // set the field null
    ...
    @Test
    public void checkFecVencCompIsRequired() throws Exception {
        int databaseSizeBeforeTest = regVentaRepository.findAll().size();
        // set the field null
        regVenta.setFecVencComp(null);
    ...
    @Test
    public void checkTipCompIsRequired() throws Exception {
        int databaseSizeBeforeTest = regVentaRepository.findAll().size();
        // set the field null
    ...
    @Test
    public void checkNroSerieCompIsRequired() throws Exception {
        int databaseSizeBeforeTest = regVentaRepository.findAll().size();
        // set the field null
    ...
    @Test
    public void checkNroCompIsRequired() throws Exception {
        int databaseSizeBeforeTest = regVentaRepository.findAll().size();
        // set the field null
    ...
    @Test
    public void checkApeRazSocCliIsRequired() throws Exception {
        int databaseSizeBeforeTest = regVentaRepository.findAll().size();
        // set the field null
    ...
    @Test
    public void checkBaseImpOperGravIsRequired() throws Exception {
        int databaseSizeBeforeTest = regVentaRepository.findAll().size();
        // set the field null
    ...
    @Test
    public void checkDsctoBaseImpIsRequired() throws Exception {
        int databaseSizeBeforeTest = regVentaRepository.findAll().size();
        // set the field null
    ...
    @Test
    public void checkIgvIpmIsRequired() throws Exception {
        int databaseSizeBeforeTest = regVentaRepository.findAll().size();
        // set the field null
    ...
    @Test
    public void checkDsctoIgvIpmIsRequired() throws Exception {
        int databaseSizeBeforeTest = regVentaRepository.findAll().size();
        // set the field null
    ...
    @Test
    public void checkImpOpeExoIsRequired() throws Exception {
        int databaseSizeBeforeTest = regVentaRepository.findAll().size();
        // set the field null
    ...
    @Test
    public void checkImpTotOpeInafecIsRequired() throws Exception {
        int databaseSizeBeforeTest = regVentaRepository.findAll().size();
        // set the field null
    ...
    @Test
    public void checkImporteTotalCompIsRequired() throws Exception {
        int databaseSizeBeforeTest = regVentaRepository.findAll().size();
        // set the field null
    ...
    @Test
    public void checkCodMonedaIsRequired() throws Exception {
        int databaseSizeBeforeTest = regVentaRepository.findAll().size();
        // set the field null
    ...
    @Test
    public void checkTipCambioIsRequired() throws Exception {
        int databaseSizeBeforeTest = regVentaRepository.findAll().size();
        // set the field null
    ...
    @Test
    public void getAllRegVentas() throws Exception {
        // Initialize the database
        regVentaRepository.save(regVenta);

        // Get all the regVentaList
        restRegVentaMockMvc.perform(get("/api/reg-ventas?sort=id,desc"))
    ...
    @Test
    public void getRegVenta() throws Exception {
        // Initialize the database
        regVentaRepository.save(regVenta);

        // Get the regVenta
        restRegVentaMockMvc.perform(get("/api/reg-ventas/{id}", regVenta.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    @Test
    public void getNonExistingRegVenta() throws Exception {
        // Get the regVenta
        restRegVentaMockMvc.perform(get("/api/reg-ventas/{id}", Long.MAX_VALUE))
            .andExpect(status().isNotFound());
    }

    @Test
    public void updateRegVenta() throws Exception {
        // Initialize the database
        regVentaRepository.save(regVenta);
        ...
        restRegVentaMockMvc.perform(put("/api/reg-ventas")
            .contentType(MediaType.APPLICATION_JSON)
        ...
        assertThat(testRegVenta.getMes()).isEqualTo(UPDATED_MES);
        ...
        assertThat(testRegVenta.isIndDel()).isEqualTo(UPDATED_IND_DEL);
    ...
    @Test
    public void updateNonExistingRegVenta() throws Exception {
        int databaseSizeBeforeUpdate = regVentaRepository.findAll().size();
    ...
    @Test
    public void deleteRegVenta() throws Exception {
        // Initialize the database
        regVentaRepository.save(regVenta);
        ...
        // Delete the regVenta
        restRegVentaMockMvc.perform(delete("/api/reg-ventas/{id}", regVenta.getId())
